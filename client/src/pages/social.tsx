      ...
      <CardFooter className="flex justify-between border-t pt-3">
        {isPosted ? (
          <div className="flex justify-between w-full">
            ...
            {/* Repost button for posts that are already posted */}
            <Button
              onClick={async () => {
                try {
                  ...
                  toast({
                    title: "Post reposted",
                    description: "Your post has been scheduled for reposting.",
                  });
                  ...
                  toast({
                    ...
                    description: "There was a problem reposting your content.",
                    variant: "destructive",
                  });
                }
              }}
