            ...
            <CardContent>
              <Calendar
                ...
                classNames={{
                  ...
                  head_row: "flex",
                  head_cell: "text-neutral-600 w-9 font-normal text-[0.9rem]",
                  row: "flex w-full mt-2",
                  cell: cn(
                    "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-neutral-100 rounded-md",
